...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Hardware',
            fields=[
                ('Hardware', models.CharField(max_length=30, primary_key=True, serialize=False, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Licencia',
            fields=[
                ('serial', models.CharField(max_length=45, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='Marcas',
            fields=[
                ('marca', models.CharField(max_length=18, primary_key=True, serialize=False, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Inventario',
